...
public class TCG extends JFrame{
	...
	private void collection() {
		...
		labelCollection.setBackground(new Color(128,128,128));
		...
		home.addActionListener(new ALstartButton());
		...
		panelCollection.setBackground(Color.BLACK);
		...
		for (int i = 0;i<=4;i++) {
			for (int j = 0 ; j<=7 ; j++) {
				creationCarte(panelCollection, j,i);
			}
		}
		
	}
	
	private void creationCarte(JPanel panel,int ligne,int colonne) {
		JPanel carte = new JPanel();
		carte.setBackground(new Color(128, 128, 128));
		GridBagConstraints gbc_carte = new GridBagConstraints();
		gbc_carte.anchor = GridBagConstraints.NORTHWEST;
		gbc_carte.gridx = colonne;
		gbc_carte.gridy = ligne;
		panel.add(carte, gbc_carte);
		GridBagLayout gbl_carte = new GridBagLayout();
		gbl_carte.columnWidths = new int[] {20, 240, 20};
		gbl_carte.rowHeights = new int[] {20, 200, 50, 50, 50, 20};
		carte.setLayout(gbl_carte);
		
		JLabel spritePiece = new JLabel("");
		spritePiece.setOpaque(true);
		spritePiece.setBackground(new Color(133, 6, 6));
		...
		carte.add(spritePiece, gbc_spritePiece);
		
		JLabel nomPiece = new JLabel("nomPièce");
		nomPiece.setOpaque(true);
		nomPiece.setBackground(new Color(140, 140, 140));
		...
		carte.add(nomPiece, gbc_nomPiece);
		
		JLabel pouvoirPiece = new JLabel("Description du pouvoir de la pièce");
		pouvoirPiece.setHorizontalAlignment(SwingConstants.CENTER);
		pouvoirPiece.setOpaque(true);
		pouvoirPiece.setBackground(new Color(140, 140, 140));
		...
		carte.add(pouvoirPiece, gbc_pouvoirPiece);
		
		JLabel mvtPiece = new JLabel("Description du mouvement de la pièce");
		mvtPiece.setHorizontalAlignment(SwingConstants.CENTER);
		mvtPiece.setOpaque(true);
		mvtPiece.setBackground(new Color(140, 140, 140));
		...
		carte.add(mvtPiece, gbc_mvtPiece);
		
		JPanel basCarte = new JPanel();
		basCarte.setBackground(new Color(128,128,128));
		...
		JLabel nbExemplaire = new JLabel("nbExemplaire");
		nbExemplaire.setHorizontalAlignment(SwingConstants.CENTER);
		nbExemplaire.setOpaque(true);
		nbExemplaire.setBackground(new Color(140, 140, 140));
