...
public class Card extends JPanel{
	...
	public Card () {
		...
		nomPiece.setBackground(new Color(202, 164, 115));
		...
		pouvoirPiece.setBackground(new Color(202, 164, 115));
		...
		mvtPiece.setBackground(new Color(202, 164, 115));
		...
		basCarte = new JPanel();
		basCarte.setBackground(new Color(222, 184, 135));
		...
		raretePiece.setBackground(new Color(202, 164, 115));
		...
		nbExemplaire.setBackground(new Color(202, 164, 115));
